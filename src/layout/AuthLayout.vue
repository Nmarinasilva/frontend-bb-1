  ...
  <div class="main-content bg-secondary">
    ...
    <div class="header bg-gradient-success py-7 py-lg-8">
        ...
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-lg-5 col-md-6">
              <h1 class="text-white">Blackbook!</h1>
              <p
                class="text-lead text-white"
              >Entre agora e gerencie o seu estoque de uma maneira fácil e intuitiva.</p>
            </div>
          </div>
        </div>
      </div>
      <div class="separator separator-bottom separator-skew zindex-100">
        ...
        >
          <polygon class="fill-secondary" points="2560 0 2560 100 0 100" />
        </svg>
      </div>
    </div>
    <!-- Page content -->
